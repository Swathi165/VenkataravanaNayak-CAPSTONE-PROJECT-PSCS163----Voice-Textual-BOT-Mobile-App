...
<body>
    ...
    <marquee>
        ShopSphere: Trusted products, quick delivery, and exceptional customer service. Shop with confidence and get everything you need at the best prices!
    </marquee>
        ...
        <div class="list">
            <div class="item">
                ...
                <div class="detail">
                    ...
                    <div class="checkout">
                        <button onclick="window.location.href='users/login.php'">ADD TO CART</button>
                        <button onclick="window.location.href='users/login.php'">CHECKOUT</button>
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="detail">
                    ...
                    <div class="checkout">
                        <button onclick="window.location.href='users/login'">ADD TO CART</button>
                        <button onclick="window.location.href='users/login'">CHECKOUT</button>
                    </div>
                </div>
            </div>
            <div class="item">
    ...
    <div class="product-container" id='best_selling'>
        ...
        <div class="view-all-btn">
            <a href='all' class="btn">View More</a>
        </div>
    </div>

...
<body>
    ...
    <div class="container">
        <div class="product-page">
                ...
                <div class="img-buttons">
                    <section class='flex'>
                        ...
                        <form action="">
                            <p class="qty">
                                ...
                                <input type="number" name="qty" id="qty-<?php echo $item['product_id']; ?>-1" min="1" max="10" step="1" value="1">
                    ...
                    <div class="cart-button">
                        <?php if (isset($_SESSION['user_id'])) { ?>
                            <a href="javascript:void(0);" onclick="addToCart(<?php echo $item['product_id']; ?>, 'qty-<?php echo $item['product_id']; ?>-1')">
                                <i class="fa fa-cart-plus" aria-hidden="true"></i> Add to Cart
                            </a>
                        <?php } else { ?>
                            <a href="javascript:void(0);" onclick="redirectToLogin(<?php echo $item['product_id']; ?>, 'qty-<?php echo $item['product_id']; ?>-1')">
                                <i class="fa fa-cart-plus" aria-hidden="true"></i> Add to Cart
                            </a>
                        <?php } ?>
            ...
            <div class="product-price">
                ...
                <h1><?php echo htmlspecialchars($item['p_name']); ?></h1>
                <p class='text-loc'><i class="fa-solid fa-location-dot"></i> Your orders will arrive within 7 days, guaranteed!</p>
                <section class='flex'>
                    <b>Quantity : </b>
                    <form action="">
                        <p class="qty">
                            <button type="button" class="qtyminus" aria-hidden="true">&minus;</button>
                            <input type="number" name="qty" id="qty-<?php echo $item['product_id']; ?>-2" min="1" max="10" step="1" value="1">
                            <button type="button" class="qtyplus" aria-hidden="true">&plus;</button>
                        </p>
                    </form>
                </section>
                <div class="cta-buttons">
                    <?php if (isset($_SESSION['user_id'])) { ?>
                        <a href="javascript:void(0);" onclick="addToCart(<?php echo $item['product_id']; ?>, 'qty-<?php echo $item['product_id']; ?>-2')">
                            <i class="fa fa-cart-plus" aria-hidden="true"></i> Add to Cart
                        </a>
                    <?php } else { ?>
                        <a href="javascript:void(0);" onclick="redirectToLogin(<?php echo $item['product_id']; ?>, 'qty-<?php echo $item['product_id']; ?>-2')">
                            <i class="fa fa-cart-plus" aria-hidden="true"></i> Add to Cart
                        </a>
                    <?php } ?>
    ...
    <script>
        ...
        function redirectToLogin(productId, qtyInputId) {
            const quantity = document.getElementById(qtyInputId).value;
